...
def get_answer_from_sheet(base_img):
    ...
    ans_img = cv2.adaptiveThreshold(ans_img,255,cv2.ADAPTIVE_THRESH_MEAN_C,cv2.THRESH_BINARY,15,2)  
    ...
    choice_img = cv2.adaptiveThreshold(choice_img,255,cv2.ADAPTIVE_THRESH_MEAN_C,cv2.THRESH_BINARY_INV,15,2)
